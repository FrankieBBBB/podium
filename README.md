...
| **[Metrics and Grafana](docs/configuration.md#metrics)** | Scraping `/api/metrics`, comparing providers from it, and an [example dashboard](docs/grafana/podium-provider-quality.json) to import |
